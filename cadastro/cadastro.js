...
// Atualize o link na tela de login para chamar showRegister()
document.querySelector(".register a").setAttribute("onclick", "showRegister()");
...
async function register() {
    ...
    const url = 'https://back-spider.vercel.app/user/cadastrarUser'; // Substitua se necessário
